...
class two_stage_2014:
    '''    
    A two-stage task based on Lee's et al., 2014. 
    '''
...
class two_stage:
    '''    
    A modified two-stage task based on Lee's et al., 2014. In this task, participants will be explicitly informed from the outset that each choice will only transition to two subsequent states. In contrast, in the task by Lee et al., this information becomes clear only through learning.
    '''
    nS = 9 #1stage(inital)+4stage(step1)+4rewardstage(stage2)
    nA = 2 #left/right
    nT = 3
